...
void start_thread(void (*function)(int, int), int threadID, int execCount) {
  ...
  init_TCB(tcb, function, stackP, stack_size, threadID, execCount); // call init_TCB with appropriate arguments
